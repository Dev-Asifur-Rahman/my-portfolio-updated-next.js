      ...
      <div className="w-full flex flex-col gap-8">
        <div className="text-center lg:text-left">
          ...
          <p className="mt-5 text-white/70 text-sm md:text-base lg:text-lg leading-relaxed max-w-4xl">
            A <span className="text-gradient">Full Stack Developer</span> passionate about creating
            modern, responsive and user-focused web applications. I enjoy
            turning ideas into interactive digital experiences using
            technologies like React, Next.js, Typescript, Node.js, Express.js
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
          ...
          <div className="glass-bg rounded-xl p-5 border border-white/10">
            ...
            <h3 className="text-xl font-bold text-white">UI/UX Focused</h3>

            <p className="mt-3 text-white/70 text-sm leading-relaxed">
              Designing smooth and visually appealing experiences with modern
